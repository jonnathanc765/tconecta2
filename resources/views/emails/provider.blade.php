                            ...
                            <tr>
                                ...
                                <td>
                                    <div align="center"
                                        ...
                                        <img src="{{ asset('images/logo2.png') }}" style="width:20% ;margin-bottom:16px;"/>
                                        <div
                                        ...
                                        <div
                                            ...
                                            Alguien ha contactado con <strong>{{ config('app.name') }}</strong> Aquí están los datos:<br><br>
                                    ...
                                    <div style="text-align:left">
                                        <div
                                            ...
                                            <div>
                                                Has recibido este correo electrónico porque alguien se registró en
                                                {{ config('app.name') }}. Si usted no tiene que ver con el contenido de este correo, ponte en
